...
Options:
1) Use this option for fast hashes such as whirlpool sha512-256, sm3, SSHA, MySQL 5.X, MD5, NTLM, SHA1, SHA2, SHA3, Blake2, SHAKE, or RIPEMD-160.
...
WARNING:BE CAREFUL WITH THE NUMBER OF PASSWORDS YOU USE. CAN BE GENERATED, IT CAN REACH UP TO GIGABYTES AND BLOCK THE SYSTEM!!!!!!!
  ...
  def get_cracking_parameters(self):
      ...
      print("INFO: unsupported combinations (14/23/35/25/62/26/63/36)")
  ...
  def rules_parameters(self,wpa_psk,password,data,crackTimeEstimate):
    ...
    symbols = ["#","!","$","%","@","&"]
    character_substitution = {"a":"@","A":"4","e":"3","E":"3","i":"1","I":"1","o":"0","O":"0","s":"$","S":" 5","t":"7","T":"7"}
    chosen_rules = self.rules if self.rules in ['1','2','3','4','5','12','13','15','21','31','51','42','24','34','43','54','45','6','64','46','61','16','56','65'] else ''
    if chosen_rules:
...
lengths and combinations with option 2\"
    ...
    if len(hash_input) == self.hash['length_md5']:
             ...
             print("Type hash:\n1)- sha256\n2)- sha3_256\n3)- blake2s\n4)- sm3\n5)- sha512-256")
             hash_algorithm_map ={"1":"sha256","2":"sha3_256","3":"blake2s","4":"sm3","5":"sha512-256"}
             self.cracking_selection(hash_input,hash,is_fast_mode,combined,wait_time,hash_algorithm_map)
