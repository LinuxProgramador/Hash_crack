...
WARNING:BE CAREFUL WITH THE NUMBER OF PASSWORDS YOU USE. CAN BE GENERATED, IT CAN REACH UP TO GIGABYTES AND BLOCK THE SYSTEM!!!!!!!
  ...
  def rules_parameters(self,wpa_psk,password,data,crackTimeEstimate):
    ...
    numbers = ["123","1","2","12","3","1234","12345","123456",123456789","54321","312","4321",]
    symbols = ["#","!","$","@","%","&","*"]
        ...
        if chosen_rules in ['1']:
           ...
           self.stored.pop(0)
            ...
            self.stored.pop(0)
              ...
              data = password.encode(self.encoder)
              self.stored.pop(0)
        if wpa_psk and chosen_rules in ['1','4','7','64','46','61','16','12','21','13','31','15','51','42','24','34','43','54','45']:
           data = None
