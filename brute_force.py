...
def crack(count, hash_input, select, wait_time):
    ...
    for password in brute_force():
        ...
        if select in ["bcrypt","pbkdf2_sha256","argon2id","scrypt"] and count == 4 and wait_time == "y":
            count = 0
            sleep(1)
...
def main(count):
    ...
    try:
        print("INFO: \"pbkdf2_sha256/scrypt/argon2id/dcc2/bcrypt/shacrypt/md5crypt/apr1/wpa-psk/ripemd-160/ntlm/sm3/phpass\" hashes tend to take longer to decrypt.")
