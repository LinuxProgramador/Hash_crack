...
def crack(count, hash_input, select, wait_time):
    ...
    for password in brute_force():
        ...
        if select == "MySQL 5.X":
            ...
            wp = new(bytes(password,encoding="utf-8"))
...
def main(count):
    ...
    try:
        print("INFO: \"dcc2/bcrypt/shacrypt/md5crypt/apr1/wpa-psk/ripemd-160/ntlm/sm3/phpass\" hashes tend to take longer to decrypt.")
